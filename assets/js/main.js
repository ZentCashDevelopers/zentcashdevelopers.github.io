...
function makeTimer() {
    var endTime = new Date("November 10, 2018 18:00:00 PDT"); // Change timer date form here...!        
...
// Apple
$(function() {
    $('#download-apple > div').hover(function() {
      $('.textbox-apple').css('display', 'none');
    }, function() {
      $('.textbox-apple').css('display', '');
    });
  });
//Windows
  $(function() {
    $('#download-windows > div').hover(function() {
      $('.textbox-windows').css('display', 'none');
    }, function() {
      $('.textbox-windows').css('display', '');
    });
  });  
// Linux
$(function() {
    $('#download-linux > div').hover(function() {
      $('.textbox-linux').css('display', 'none');
    }, function() {
      $('.textbox-linux').css('display', '');
    });
  });
// Android
  $(function() {
    $('#download-android > div').hover(function() {
      $('.textbox-android').css('display', 'none');
    }, function() {
      $('.textbox-android').css('display', '');
    });
  });
//-------------------Inverter--------------------//
...
// Apple
  $(function() {
    $('#download-apple > div').hover(function() {
      $('.downloads-apple').css('display', 'block');
    }, function() {
      $('.downloads-apple').css('display', '');
    });
  });
...
// Windows  
  $(function() {
    $('#download-windows > div').hover(function() {
      $('.downloads-windows').css('display', 'block');
    }, function() {
      $('.downloads-windows').css('display', '');
    });
  });  
...
// Linux
  $(function() {
    $('#download-linux > div').hover(function() {
      $('.downloads-linux').css('display', 'block');
    }, function() {
      $('.downloads-linux').css('display', '');
    });
  });
...
// Android  
  $(function() {
    $('#download-android > div').hover(function() {
      $('.downloads-android').css('display', 'block');
    }, function() {
      $('.downloads-android').css('display', '');
    });
  });
